...
namespace LeaveManagementSystem.Data.Migrations
{
    ...
    [Migration("20260403204057_AddDepartmentsAndHolidayss")]
    partial class AddDepartmentsAndHolidayss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9bbf66bf-e293-4231-9868-791ffa988c12",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIm72kVf//oY+oyqScVoN+OJdOnO99GKB8qbhq3MBakfFAn5tn2QNXIdNDjtPAYgDw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e7d22551-4d03-406c-b958-3cff153886f1",
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.Migrations.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.ApplicationUser", b =>
                {
                    b.HasOne("LeaveManagementSystem.Data.Migrations.Department", "Department")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("LeaveManagementSystem.Data.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("LeaveManagementSystem.Data.ApplicationUser", "Reviwer")
                        .WithMany()
